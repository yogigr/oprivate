	...
	<div>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title">Penghargaan</h5>
		...
		<div class="modal" tabindex="-1" role="dialog" id="AchCertificateModal">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title">Sertifikat Penghargaan</h5>
				        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
				          	<span aria-hidden="true">&times;</span>
				        </button>
					</div>
	...
	export default {
		...
		methods: {
			...
			saveAch: function(){
				...
				let url = '/teacher/profile/achievement'
			...
			updateAch: function(){
				...
				let url = '/teacher/profile/achievement/' + this.ach.id
			...
			deleteAch: function(data, index){
				axios.delete('/teacher/achievement/'+data.id)
				.then(response => {
					this.notify(response.data.message, 'success')
