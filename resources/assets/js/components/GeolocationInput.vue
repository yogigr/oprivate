<template>
	<div>
		<div class="row">
			<div class="col-sm-12">
				<div class="page-header">Lokasi</div>
			</div>
			<div class="col-sm-8">
				<div id='map' style="width: 100%; height: 300px"></div>
			</div>
			<div class="col-sm-4">
				<div :class="{'form-group': true, 'has-error': latHasError}">
					<label>Latitude</label>
					<input type="text" v-model="latitude" name="latitude" class="form-control" readonly>
				</div>
				<div :class="{'form-group': true, 'has-error': longHasError}">
					<label>Longitude</label>
					<input type="text" v-model="longitude" name="longitude" class="form-control" readonly>
				</div>
			</div>
		</div>
	</div>
